<?php  // $Id$
/**
 * Unit tests for (some of) question/type/ipatranscription/questiontype.php.
 *
...
class question_ipatranscription_qtype_test extends UnitTestCase {
    var $qtype;
    
    function setUp() {
        $this->qtype = new question_ipatranscription_qtype();
    }
    ...
    function test_name() {
        $this->assertEqual($this->qtype->name(), 'ipatranscription');
    }
